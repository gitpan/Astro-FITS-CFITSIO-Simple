...
preserved. The user may override this type using the C<-dtypes> option
(see the description under "Table Options"below).
...
by specifying the PDL type (via C<-dtypes>) as the string C<logical>.
